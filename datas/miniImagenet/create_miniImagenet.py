...
pathImageNet = '/flush1/zha230/ILSVRC/Data/CLS-LOC/train'
pathminiImageNet = '/data/zha230/LearningToCompare_FSL-master/datas/miniImagenet/'
    ...
    with open(filename) as csvfile:
        ...
        for row in tqdm(csv_reader):
            if row[1] in images.keys():
                ...
                images[row[1]] = [row[0]]
        print(images.keys()[0])
        print((os.path.join(pathImageNet, images.keys()[0])))
